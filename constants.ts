...
export const COLORS = {
  ...
  taskbarBlue: '#103b9a',
  loginTop: '#1e4fb8',
  loginBg: '#6fa1ea', // Base for gradient
  progressBar: '#2b66d6',
  orangeAccent: '#e75a25',
  white: '#FFFFFF',
  startGreen: '#2aa01b',
...
export const ASSETS = {
  wallpaper: 'https://preview.redd.it/microsoft-design-team-shared-an-updated-4k-version-of-the-v0-9owhc7wuc65b1.jpg?auto=webp&s=8981649e0186af9fc55b8be44724c9779d9793c0', 
  avatar: 'https://i.ibb.co/Mxys1Yqw/Aareev-Professional-Pic.png',
  soundLogin: 'https://www.myinstants.com/media/sounds/windows-xp-startup.mp3', // Updated to working URL
  windowsLogo: 'https://upload.wikimedia.org/wikipedia/commons/5/5f/Windows_XP_icon.png',
};

// Using reliable sources for icons (IconArchive, Wikimedia) to ensure loading
export const XP_ICONS = {
  ...
  projects: 'https://i.ibb.co/chDDYFps/Internet-Explorer-6.png', // IE6 Icon
  ...
  music: 'https://mitchivin.com/assets/gui/start-menu/music.webp',
  ...
  // System
  logoff: 'https://i.ibb.co/Q7kDQdW4/Logout.png', // Key icon
  shutdown: 'https://mitchivin.com/assets/gui/start-menu/shutdown.webp', // Red button icon
  restart: 'https://i.ibb.co/BK7tZNhn/Restart.png', // Green Restart icon
  
  // All Programs
  folder: 'https://icons.iconarchive.com/icons/dtafalonso/yosemite-flat/512/Folder-icon.png',
  ...
  claude: 'https://upload.wikimedia.org/wikipedia/commons/1/14/Claude_AI_logo.svg', // Placeholder/Generic
...
const UnstoppableMp3 = new URL('./Music Assets/The_Score_-_the_score_unstoppable_(mp3.pm).mp3', import.meta.url).href;
const DangerousMp3 = new URL('./Music Assets/The_EverLove_-_I_m_Dangerous_(mp3.pm).mp3', import.meta.url).href;
const FightDevilMp3 = new URL('./Music Assets/Onlap_-_Fight_Like_the_Devil_Alt._Rock_Modern_Rock_(mp3.pm).mp3', import.meta.url).href;
const SkyfallMp3 = new URL('./Music Assets/Skyfal_-_Adele_(mp3.pm).mp3', import.meta.url).href;

// Supported Types: 'youtube' | 'file'
export const MUSIC_TRACKS: MusicTrack[] = [
  {
    title: "Unstoppable",
    artist: "The Score",
    cover: "https://i.scdn.co/image/ab67616d0000b273c469e75608b59994c1c422be",
    type: 'file',
    url: UnstoppableMp3
  },
  {
    title: "I'm Dangerous",
    artist: "The Everlove",
    cover: "https://cdn-images.dzcdn.net/images/cover/6ded02f67cfcf52aec37f52018210ec3/500x500.jpg",
    type: 'file',
    url: DangerousMp3
  },
  {
    title: "Fight Like The Devil",
    artist: "ONLAP",
    cover: "https://cdn-images.dzcdn.net/images/cover/bcaad907916e785c66c36fa139c6ba37/0x1900-000000-80-0-0.jpg",
    type: 'file',
    url: FightDevilMp3
  },
  {
    title: "Skyfall",
    artist: "Adele",
    cover: "https://upload.wikimedia.org/wikipedia/en/4/45/Skyfall_cover.png",
    type: 'file',
    url: SkyfallMp3
  }
];